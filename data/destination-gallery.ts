...
export const destinationGallery: Record<string, GalleryImage[]> = {
    ...
    capri: [
        ...
        { src: px(27940645), alt: 'Vista aerea di Capri'},
        { src: px(33336433), alt: 'Bar in Capri'},
        { src: px(33336429), alt: 'Vicolo a Capri'},
        { src: px(36717897), alt: 'Giardino lussureggiante a Capri, atmosfera Villa Lysis', credit: 'Foto: Violeta Galeana / Pexels' },
        { src: px(36471721), alt: 'Vetrina negozio a Capri'},
        ...
        { src: px(28580408), alt: 'Faraglioni di Capri al tramonto'},
    ],
    ...
    procida: [
        ...
        { src: px(26976100), alt: 'Vicolo caratteristico di Procida con barche e facciate colorate', credit: 'Foto: Josh Withers / Pexels' },
        ...
        { src: px(26976094), alt:'Facciata di casa a Procida con barchetta', credit: 'Foto: Josh Withers / Pexels' },
        { src: px(13610997), alt: 'Vista aerea del borgo di Marina Corricella a Procida', credit: 'Foto: Nati / Pexels' },
        { src: px(13613091), alt: 'Barche al pontile di Marina Corricella', credit: 'Foto: Nati / Pexels' },
        { src: px(13613152), alt: 'Sedia souvenir shop a Procida' },
    ],
    ...
    sicilia: [
        ...
        { src: px(18282035), alt:'Duomo di Palermo' },
        { src: px(20406063), alt: 'Vista aerea di Isola Bella a Taormina', credit: 'Foto: Aleksandra S / Pexels' },
        { src: px(37861659), alt: 'Escursionisti che esplorano il paesaggio aspro dell’Etna, in Sicilia, sotto un cielo limpido.', credit: 'Foto: Pexels' },
        { src: px(29311299), alt: 'Teatro antico di Taormina', credit: 'Foto: Pexels' },
        { src: px(2998945), alt: 'Cassata siciliana su un piatto a Noto', credit: 'Foto: Pexels' },
        { src: px(26971420), alt: 'Borgo siciliano arroccato su una collina', credit: 'Foto: Leotrim Canaj / Pexels' },
        { src: px(17056555), alt: 'Valle dei Templi, Agrigento', credit: 'Foto: Andrea Mosti / Pexels' },
