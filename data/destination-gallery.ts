...
export const destinationGallery: Record<string, GalleryImage[]> = {
    ...
    ischia: [
        ...
        },
        {
            ...
            caption: 'Sant’Angelo: borgo pedonale, terme naturali, ritmo lento.',
        ...
        { src: px(36834243), alt: 'Porto di Ischia visto dall’alto', credit: 'Foto: Ree A / Pexels' },
    ...
    procida: [
        ...
        },
        {
            ...
            caption: 'Procida è piccola, lenta e marittima, un sogno ad occhi aperti.',
            credit: 'Foto: Josh Withers / Pexels',
        },
        { src: px(26976121), alt: 'Barche ormeggiate nel porto di Procida', credit: 'Foto: Josh Withers / Pexels' },
        ...
        { src: px(35485756), alt: 'Traghetto attraccato all’isola di Procida', credit: 'Foto: Magda Ehlers / Pexels' },
        { src: px(31665694), alt: 'Vista pittoresca del porto di Procida', credit: 'Foto: Raffaele Felaco / Pexels' },
        { src: px(29186114), alt: 'Porto di Procida con barche e architettura caratteristica', credit: 'Foto: Ciro Palomba / Pexels' },
    ...
    sorrento: [
        ...
        { src: px(10229033), alt: 'Barche ormeggiate nel porto di Sorrento', credit: 'Foto: Daniel Eliashevsky / Pexels' },
    ],
    ...
    amalfi: [
        ...
        { src: px(19143180), alt: 'Vista aerea del Duomo di Amalfi', credit: 'Foto: Kelly / Pexels' },
    ...
    sicilia: [
        ...
        { src: px(4563289), alt: 'Teatro antico di Taormina', credit: 'Foto: Bruggi / Pexels' },
    ...
    sardegna: [
        ...
        { src: px(18198583), alt: 'Vicolo stretto di un borgo sardo in pietra', credit: 'Foto: Efrem Efre / Pexels' },
    ],
    ...
    roma: [
        ...
        { src: px(7473036), alt: 'Piazza Navona a Roma', credit: 'Foto: Esra Geziyor / Pexels' },
    ...
    toscana: [
        ...
        },
        {
            ...
            caption: 'Firenze, Siena, vigneti, la Toscana si cammina lentamente.',
        ...
        { src: px(29990363), alt: 'Colline toscane all’alba', credit: 'Foto: Duc Tinh Ngo / Pexels' },
